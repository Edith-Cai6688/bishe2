...
# %%
try:
    dataset_metadata = LeRobotDatasetMetadata("my_pi0", root='./demo_data_language')
except:
    dataset_metadata = LeRobotDatasetMetadata("my_pi0", root='./demo_data_language')
...
policy = PI0Policy.from_pretrained('./ckpt/my_pi0/checkpoints/010000/pretrained_model', dataset_stats=dataset_metadata.stats)
